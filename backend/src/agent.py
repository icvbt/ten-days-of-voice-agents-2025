...
# Default FAQ data for "Jerry AI Store"
DEFAULT_FAQ = [
    {
        "question": "What do you sell?",
        "answer": "We offer Voice AI Agent development."
    },
    {
    ...
    },
    {
        ...
        "answer": "Yes! We offer free voice generation credits."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Jerry AI Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with jerry and email you." (Don't hallucinate prices).
            """,
